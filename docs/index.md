...
!!! info
    ...
    **Source Code Repository:** [https://github.com/rhdh-JslYoon-org/agentic-audio-text-sep11-4](https://github.com/rhdh-JslYoon-org/agentic-audio-text-sep11-4)

    **GitOps Repository:** [https://github.com/rhdh-JslYoon-org/agentic-audio-text-sep11-4-gitops](https://github.com/rhdh-JslYoon-org/agentic-audio-text-sep11-4-gitops)

# **Usage**

To access the agentic-audio-text-sep11-4 application that was deployed using the Software Template, complete the following instructions:
